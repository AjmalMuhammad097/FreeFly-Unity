...
public class GameData
{
    ...
    {
        MyPlayerPrefs.SetJson(Constants.GAME_PROGRESS_PLAYERPREFS, Progress);
    }

    public void LoadProgress()
    {
        Progress = MyPlayerPrefs.GetJson<Progress>(Constants.GAME_PROGRESS_PLAYERPREFS, new());
    }

    public void SaveConfiguration()     //For Backup
    {
        MyPlayerPrefs.SetJson(Constants.GAME_CONFIGURATION_PLAYERPREFS, Configuration);
    }

    public void LoadConfiguration()
    {
        Configuration = MyPlayerPrefs.GetJson<Configuration>(Constants.GAME_CONFIGURATION_PLAYERPREFS, new());
    }
}
